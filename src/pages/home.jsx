                ...
                <div className='container d-flex d-column align-items-center'>
                    ...
                    <div className='row mb-5 w-100'>
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            <h3 className='fs-2 mb-5'>Coffee</h3>
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Flat White L</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>17 Ron</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Americano L</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>14 Ron</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Macchiato L</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>16 Ron</p>
                                </li>
                            </ul>
                        </div>
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            <h3 className='fs-2 mb-5'>Tea</h3>
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Nibbana Ginger Tea</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>18 Ron</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            <h3 className='fs-2 mb-5'>Lemonade</h3>
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Nibbana Ginger Tea</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>18 Ron</p>
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            <h3 className='fs-2 mb-5'>Smoothie</h3>
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Berries Smoothie</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>19 Ron</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Smoothie cu fructe tropicale</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>20 Ron</p>
                                </li>
                                <li className='d-flex justify-content-between'>
